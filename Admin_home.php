                    ...
                    <div class="greennature-navigation-wrapper">
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                ...
                                <li class="menu-item menu-item-has-children"><a href="buy.php" class="sf-with-ul-pre">Buy crop History</a></li>
                                <li class="menu-item menu-item-has-children"><a href="buy_product.php" class="sf-with-ul-pre">Buy product History</a></li>
								<li class="menu-item menu-item-home current-menu-item greennature-normal-menu"><a><i class="fa fa-home"></i>AUCTION</a>
                                <ul class="sub-menu">
								<li class="menu-item"><a href="acution_apply_user_list.php"> Auction Apply list</a></li>
								<li class="menu-item"><a href="auction_form.php">Add Acution</a></li>
                                
								</ul></li>

								<li class="menu-item menu-item-has-children greennature-normal-menu"><a href="crop_add.php" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>Crop</a>
                                <ul class="sub-menu">
								<li class="menu-item"><a href="crop_view_admin.php"> crop list </a></li>
								<li class="menu-item"><a href="product_view_admin.php">product list </a></li>
                                
								</ul></li>  
                                    
								<li class="menu-item menu-item-has-children greennature-normal-menu"><a  class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>Loan</a>
                                <ul class="sub-menu">
								<li class="menu-item"><a href="loan_noti_admin.php">Add Loan</a></li>
								<li class="menu-item"><a href="loan_view_apply_list.php">list of Applicant</a></li>
                                ...
                                <div class="greennature-item-title-wrapper greennature-item  greennature-left-divider greennature-medium ">
                                    <div class="greennature-item-title-container container">
                                        <div class="greennature-item-title-head">
                                            <h3 class="greennature-item-title greennature-skin-title greennature-skin-border"><img src="upload/icon-5.png" alt="" width="80" height="80" />Our Recent Projects</h3><a class="greennature-item-title-link" href="#">More Projects</a>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="portfolio-item-holder  greennature-portfolio-column-4">
                                        <div class="greennature-isotope" data-type="portfolio" data-layout="fitRows">
                                            ...
                                            <div class="three columns">
                                                <div class="greennature-item greennature-portfolio-item greennature-classic-portfolio">
                                                    <div class="greennature-ux greennature-classic-portfolio-ux">
                                                        <div class="portfolio-thumbnail greennature-image"><img src="upload/shutterstock_124871620-540x326.jpg" alt="" width="540" height="326" /><span class="portfolio-overlay">&nbsp;</span><a class="portfolio-overlay-icon" href="#"><span class="portfolio-icon" ><i class="fa fa-link" ></i></span></a></div>
                                                        <div class="portfolio-classic-content">
