                    ...
                    <div class="greennature-navigation-wrapper">
                        ...
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                ...
                                <li class="menu-item m-enu-item-has-childrenmenu-item menu-item-has-children greennature-mega-menu"><a href="logout.php" class="sf-with-ul-pre"><i class="fa fa-globe"></i>Logout</a>
                        ...
                        <div class="clear"></div>
                          <h3 class="text-white sta">Crop Table</h3>
                    </div>
                    <div class="clear"></div>
...
$query=$mysql->query("select * from tb_crop");
	...
	foreach($query as $value=>$row)
    {
	 ...
	 <a href='fa_buy_action.php?id=".$row['id']."' class='btn btn-block btn-info'>Buy</a></td></tr>";
