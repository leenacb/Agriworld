...
<nav class="greennature-navigation" id="greennature-main-navigation">
	<ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
		<li></li>
		<li class="menu-item menu-item-home current-menu-item greennature-normal-menu"><a href="index.php"><i class="fa fa-home"></i>Home</a></li>
		...
		<li class="menu-item m-enu-item-has-childrenmenu-item menu-item-has-children greennature-mega-menu"><a href="login.php" class="sf-with-ul-pre"><i class="fa fa-globe"></i>Login</a>
...
<div class="clear"></div>
	...
	<div>
		...
		<div class="main-agileinfo top">
		<h1 class="text-white"> Seller Registration Form</h1>
			<div class="agileits-top shade">
				...
				<br>	<input class="text" type="text" name="lastname" placeholder="Lastname" required="">
					...
					<input type="submit" value="Register" class="btn bg-danger">
				</form>
