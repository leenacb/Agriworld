                ...
                <div class="greennature-header-container container">
                    ...
                    <div class="greennature-logo">
                        <div class="greennature-logo-inner">
							...
							<h4 style="color:white">FARMER NAME:<?php echo $name; ?></h4>
                    ...
                    <div class="greennature-navigation-wrapper">
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                <li class=" current-menu-item greennature-normal-menu"><a href="farmer_update.php">profile Updation</a></li>
								<ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                <li class="menu-item menu-item-home current-menu-item greennature-normal-menu"><a href="">Buy crop</a>
								<ul class="sub-menu">
								<li class="menu-item"><a href="product_view.php">Product</a></li>
								<li class="menu-item"><a href="farmer_crop_view.php">Crop</a></li>
								</ul>
                                </ul>
								<li class=" current-menu-item greennature-normal-menu"><a href="farmer_auction_table.php"><i class=""></i>Auction</a></li>
								<li class="menu-item menu-item-has-children greennature-normal-menu"><a href="farmer_crop.php" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>Add Crop</a>
								<li class="menu-item menu-item-has-children greennature-normal-menu"><a href="table_loan_view.php" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>Apply loan</a>
								
                                    
                                </li>
                                <li class="menu-item menu-item-has-children greennature-normal-menu"><a href="my_order.php" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>My oreders</a>
